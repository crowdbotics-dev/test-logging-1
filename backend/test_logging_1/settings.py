"""
Django settings for test_logging_1 project.
...
ROOT_URLCONF = 'test_logging_1.urls'
...
WSGI_APPLICATION = 'test_logging_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_logging_1 API",
    "DESCRIPTION": "API documentation for test_logging_1 App",
    "VERSION": "v1",
}
